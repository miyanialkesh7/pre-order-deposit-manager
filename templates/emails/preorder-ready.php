    ...
    <table role="presentation" class="wcpd-wrap" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;width:600px;">
        ...
        <tr>
            <td class="wcpd-card" style="background:#ffffff;border-radius:12px;padding:40px 32px;text-align:center;box-shadow:0 4px 6px -1px rgba(0,0,0,0.04);">
                ...
                <h2 style="margin:0 0 8px 0;font-size:20px;font-weight:700;color:#0f172a;"><?php _e('Your product is ready', 'pre-order-deposit-manager'); ?></h2>
                <p style="margin:0;font-size:15px;color:#64748b;line-height:1.5;">
                    <?php
                    printf(
                        /* translators: %s: order number wrapped in a styled <strong> tag. */
                        __('Hi! Your pre-order %s is now ready for delivery.', 'pre-order-deposit-manager'),
        ...
        <tr>
            <td class="wcpd-card" style="background:#ffffff;border-radius:12px;padding:32px;box-shadow:0 4px 6px -1px rgba(0,0,0,0.04);">
                <h3 style="margin:0 0 20px 0;font-size:14px;text-transform:uppercase;letter-spacing:1px;color:#94a3b8;font-weight:700;"><?php _e('Payment Summary', 'pre-order-deposit-manager'); ?></h3>

                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                        <td style="padding:12px 0;border-bottom:1px solid #f1f5f9;">
                            <span style="font-size:14px;color:#64748b;"><?php _e('Total Value', 'pre-order-deposit-manager'); ?></span>
                        </td>
                    ...
                    <tr>
                        <td style="padding:12px 0;border-bottom:1px solid #f1f5f9;">
                            <span style="font-size:14px;color:#64748b;"><?php _e('Deposit Paid', 'pre-order-deposit-manager'); ?></span>
                        </td>
                        <td align="right" style="padding:12px 0;border-bottom:1px solid #f1f5f9;">
                    ...
                    <tr>
                        <td style="padding:16px 0 0 0;">
                            <span style="font-size:14px;color:#0f172a;font-weight:600;"><?php _e('Remaining Amount', 'pre-order-deposit-manager'); ?></span>
                        </td>
                ...
                <div style="margin-top:28px;padding:16px;background:#f5f3ff;border-radius:8px;border-left:4px solid #4f46e5;">
                    <p style="margin:0;font-size:13px;color:#3730a3;line-height:1.5;">
                        <?php _e('Please complete the payment as soon as possible so we can deliver your order. If you have any questions, our team is happy to help.', 'pre-order-deposit-manager'); ?>
                    </p>
                </div>
            </td>
        </tr>
